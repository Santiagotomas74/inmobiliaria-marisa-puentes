...
export default function JoseCPazPage() {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        const res = await fetch("/api/properties?city=jose-c-paz");
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white gap-6">
      ...
      <div className="flex flex-col items-center gap-2 text-gray-600 mt-2">
        ...
        <p className="text-sm font-medium">Cargando propiedades de Jose C. Paz...</p>
      </div>
    ...
    <main className="bg-gray-100 h-full py-10">
      ...
      <div className="max-w-7xl mx-auto px-6 ">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-4">
          Propiedades en Jose C. Paz
        </h1>
  
        <p className="text-gray-600 mb-8 max-w-2xl">
          Descubrí las mejores propiedades en Jose C. Paz. Casas, departamentos y
        ...
        {properties.length === 0 && (
          <p className="text-gray-500 mt-10">
            No hay propiedades disponibles en Jose C. Paz por el momento.
          </p>
        )}
