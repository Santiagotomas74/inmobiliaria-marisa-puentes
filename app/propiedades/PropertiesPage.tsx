...
export default function PropertiesPage() {
  ...
  const filteredProperties = properties.filter((prop) => {
    if (filters.operation && prop.operation !== filters.operation) return false;
    ...
    if (filters.rooms && prop.bedrooms < Number(filters.rooms)) return false;

    const price = filters.currency === "usd" ? prop.price : prop.price_ars;
      ...
      <div className="w-full px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-10">
          ...
          <div>
            ...
            {/* 🏠 GRID */}
            <div className="grid sm:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-3 gap-6">
              {/* 💀 SKELETON */}
              {loading &&
                [...Array(8)].map((_, i) => (
                  <div
              ...
              {filteredProperties.map((prop) => (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    {/* 📍 UBICACIÓN */}
                    <MapPinHouse
                      className="absolute text-black mt-1"
                      size={18}
                    />
