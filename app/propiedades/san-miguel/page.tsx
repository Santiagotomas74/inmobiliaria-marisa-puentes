...
export default function SanMiguelPage() {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        const res = await fetch("/api/properties?city=San Miguel");
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white gap-6">
      ...
      <div className="flex flex-col items-center gap-2 text-gray-600 mt-2">
        ...
        <p className="text-sm font-medium">Cargando propiedades de San Miguel...</p>
      </div>
    ...
    <main className="bg-gray-100 h-full py-10">
      ...
      <div className="max-w-7xl mx-auto px-6 ">
        ...
        <p className="text-gray-600 mb-8 max-w-2xl">
          Descubrí las mejores propiedades en San Miguel. Casas, departamentos y
        ...
        {properties.length === 0 && (
          <p className="text-gray-500 mt-10">
            No hay propiedades disponibles en San Miguel por el momento.
          </p>
        )}
