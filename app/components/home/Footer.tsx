    ...
    <footer className="bg-[#0B1120] text-gray-400 py-16 px-6 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="">
            ...
            <p className="text-sm leading-relaxed mb-8">
              Dedicados a ayudarte a encontrar no solo una casa, sino un hogar
              donde crear recuerdos inolvidables.
            </p>
            {/* Redes Sociales */}
            <div className="flex gap-3">
              <a
                href="https://www.facebook.com/profile.php?id=100077570449805"
                className="bg-[#1E293B] hover:bg-blue-600 text-white w-9 h-9 rounded-full flex items-center justify-center transition-colors"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
              ...
              <a
                href="https://www.instagram.com/marisapuentes_propiedades/#"
                className="bg-[#1E293B] hover:bg-blue-600 text-white w-9 h-9 rounded-full flex items-center justify-center transition-colors"
              >
                <svg
                  className="w-4 h-4"
        ...
        <div className="mt-10 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500 gap-4">
          <p>
            © 2026 Marisa Puentes Propiedades. Todos los derechos reservados.
          </p>
        </div>
