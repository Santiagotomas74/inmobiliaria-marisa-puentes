...
export default function ContactSection() {
  ...
  const phonesMatch = form.phone.trim() === form.confirmPhone.trim();
          ...
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white p-6 md:p-10 flex flex-col justify-between">
            <div>
              ...
              <p className="text-blue-100 mb-6 md:mb-8 text-sm md:text-base">
                ¿Listo para dar el siguiente paso? Nuestros expertos están
                esperando.
              </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                ...
                <input
                  ...
                  className={`border p-2.5 md:p-3 rounded-lg text-gray-700 text-sm md:text-base md:col-span-2 ${
